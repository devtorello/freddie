...
export const isOk = <T, E extends string>(result: Result<T, E>): result is Success<T> => result.ok;
export const isError = <T, E extends string>(result: Result<T, E>): result is Failure<E> => !result.ok;
